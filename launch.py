...
def treat_image(img_config):
	...
	os.system("cd ../stable-diffusion ; python3 /home/optionizr/stable-diffusion/scripts/img2img.py --ckpt 'models/ldm/stable-diffusion-v1/model.ckpt' --prompt '" + img_config["final_img_description"] + "' --init-img /home/optionizr/MODnet/" + path_pasted_background_img + " --strength 0.4 --outdir /home/optionizr/outputs --seed " + str(randint(1, 100)))
